...
const MainMirai = () => {
    return (
      <div className="relative min-h-screen w-full">
        <div className="relative flex flex-col items-center bottom-[100px]">
          <h1
        ...
        <p
          className="absolute left-1/2 transform -translate-x-1/2 bottom-[200px]"
        ...
        <motion.div
          className="absolute left-1/2 transform -translate-x-1/2 bottom-[40px] flex flex-row items-center gap-3"
